...
function markssheet(){
    ...
    // to show only 2 digits after decimal point
    let percentageafter2digits=parseFloat(percentage).toFixed(2)     
    document.querySelector("#percent").innerHTML=`${percentageafter2digits} % `;
